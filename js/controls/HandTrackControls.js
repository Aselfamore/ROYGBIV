var HandTrackControls = function(params){
  this.isControl = true;
...
HandTrackControls.prototype.onClick = noop;
HandTrackControls.prototype.onSwipe = noop;
HandTrackControls.prototype.onPinch = noop;
HandTrackControls.prototype.onMouseWheel = noop;
HandTrackControls.prototype.onKeyUp = noop;
HandTrackControls.prototype.onDrag = noop;

HandTrackControls.prototype.init = function(){
...
HandTrackControls.prototype.onFullScreenChange = function(isFullScreen){
  if (activeControl.requestFullScreen && !isFullScreen){
    fullScreenRequested = true;
  }
}

HandTrackControls.prototype.jump = function(isDouble){
...
HandTrackControls.prototype.goBackward = function(){
...
HandTrackControls.prototype.goForward = function(){
  if (activeControl.zVelocity == -activeControl.speed){
    return;
  }
  activeControl.zVelocity -= activeControl.speed;
...
HandTrackControls.prototype.goLeft = function(){
...
HandTrackControls.prototype.goRight = function(){
  if (activeControl.xVelocity == activeControl.speed){
    return;
  }
  activeControl.xVelocity += activeControl.speed;
...
HandTrackControls.prototype.onPointerLockChange = function(isPointerLocked){
}

HandTrackControls.prototype.onMouseMove = function(event){
...
HandTrackControls.prototype.onTouchStart = function(event){
...
HandTrackControls.prototype.onLeftHandFinger = function(touch){
...
HandTrackControls.prototype.onRightHandFinger = function(touch){
  if (activeControl.pausedDueToScreenOrientation){
    return;
  }
  var oldTouch = activeControl.touchTrack.get(touch.identifier);
...
HandTrackControls.prototype.isTouchOnTheRightSide = function(touch){
...
HandTrackControls.prototype.onTouchMove = function(event){
...
HandTrackControls.prototype.onTouchEnd = function(event){
  for (var i = 0; i<event.changedTouches.length; i++){
    var curTouch = event.changedTouches[i];
...
HandTrackControls.prototype.pauseDueToScreenOrientation = function(){
  this.onPause();
...
HandTrackControls.prototype.resume = function(){
  this.onResume();
...
HandTrackControls.prototype.applyCustomVelocity = function(axis, velocity, milliseconds){
  if (axis == "x"){
...
HandTrackControls.prototype.update = function(){
...
HandTrackControls.prototype.onlookRaycasterComplete = function(x, y, z, objName){
...
HandTrackControls.prototype.lookIntersectionTest = function(){
...
HandTrackControls.prototype.resetJoystickStatus = function(){
  activeControl.joystickStatus.left = false;
  activeControl.joystickStatus.right = false;
  activeControl.joystickStatus.up = false;
  activeControl.joystickStatus.down = false;
...
HandTrackControls.prototype.onDoubleTap = function(touch){
  activeControl.jump(true);
}

HandTrackControls.prototype.onTap = function(touch){
  if (activeControl.pausedDueToScreenOrientation){
    return;
  }
...
HandTrackControls.prototype.onKeyDown = function(event){
...
HandTrackControls.prototype.onMouseDown = function(){
  activeControl.isMouseDown = true;
}

HandTrackControls.prototype.onMouseUp = function(){
  activeControl.isMouseDown = false;
}

HandTrackControls.prototype.onResize = function(){
  if (activeControl.hasWeapon1){
...
HandTrackControls.prototype.updateGunAlignment = function(gunIndex, x, y, z){
  camera.position.copy(this.playerBodyObject.mesh.position);
  this.resetRotation();
  camera.updateMatrix();
...
HandTrackControls.prototype.resetRotation = function(){
...
HandTrackControls.prototype.onDeactivated = function(doNotShowElements){
  this.deactivated = true;
...
HandTrackControls.prototype.onTrackingUpdate = function(){
  this.onResize();
  this.trackingUpdateNeeded = false;
}

HandTrackControls.prototype.onPlayerBodyCollision = function(event){
...
HandTrackControls.prototype.onActivated = function(){
  this.resetRotation();
